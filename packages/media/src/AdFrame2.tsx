...
<html>
    ...
    <body>
        ...
        <script src="${process.env.REACT_APP_AD_HOST}/${process.env.REACT_APP_ATAG_FILE}" data-mediaId=${process.env.REACT_APP_MEDIA_ID} data-placementId="placement-2222"></script>
    </body>
</html>
  `;
